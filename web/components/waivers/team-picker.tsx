 ...
 * navigated pattern `components/lineup/team-picker.tsx` established for
 * this app's other per-team analysis pages (a real computation per team,
 * not a cheap client-side toggle).
 */
    ...
    <nav className="flex gap-1 overflow-x-auto pb-1" aria-label="Choose a team">
      {teams.map((team) => {
        ...
        return (
          <Link
            key={team.team_id}
            href={`/league/${leagueId}/waivers?team=${team.team_id}`}
